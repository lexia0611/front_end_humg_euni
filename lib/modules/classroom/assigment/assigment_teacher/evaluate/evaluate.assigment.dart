...
import 'evaluate.assigment.cubit.dart';
import 'evaluate.assigment.cubit.state.dart';

class EvaluateAssigmentPage extends StatelessWidget {
  const EvaluateAssigmentPage({super.key});
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          controller: context.read<EvaluateAssigmentCubit>().point,
                          onChanged: (value) {
                            context.read<EvaluateAssigmentCubit>().changeInput();
                          },
                        ),
                      ),
                    ),
                    ...
                    InkWell(
                      onTap: (state.showButton)
                          ? () {
                              ...
                              context.read<EvaluateAssigmentCubit>().sendPoint();
                            }
                          : null,
                      child: Icon(
                        Icons.send,
